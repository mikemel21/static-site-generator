...
class TestTextNode(unittest.TestCase):
    ...
    def test_eq_url(self):
        ...
        node2 = TextNode("This is a text node", text_type_bold, "https://boot.dev")
        self.assertEqual(node, node2)

    def test_eq_url_false(self):
        node = TextNode("This is a text node", text_type_bold, "https://shoe.dev")
        node2 = TextNode("This is a text node", text_type_bold, "https://boot.dev")
        self.assertNotEqual(node, node2)
...
class TestTextNodetoHTMLNode(unittest.TestCase):
    def test_text(self):
        node = TextNode("Text Node", text_type_text, "https://www.boot.dev")
